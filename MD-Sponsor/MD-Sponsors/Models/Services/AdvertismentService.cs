...
using MD_Sponsors.Models.Interfaces;
...
namespace MD_Sponsors.Models.Services
{
    public class AdvertismentService : IAdvertismentManager
    {
        ...
        public async Task UpdateAdvertisment(int id, [Bind("ID, Name, Endorsment, ReferralCode, Image")] Advertisment Ad)
        {
            _context.Update(Ad);
            await _context.SaveChangesAsync();
        }
